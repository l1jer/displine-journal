<!--
 * @Author: Jerry Li
 * @Date: 2020-09-13 20:32:54
 * @LastEditTime: 2020-09-14 01:37:08
 * @LastEditors: Jerry Li
 * @Description: Well..
 * @FilePath: /Self_Displine/_studyJournal/vue/Vue.md
-->
...
- [深入 Vue 源码分析](#深入-vue-源码分析)
  - [响应式源码分析](#响应式源码分析)
  - [异步更新队列](#异步更新队列)
  - [Diff 算法分析](#diff-算法分析)
  - [Computed & Watch 源码分析](#computed--watch-源码分析)
...
接收一个组件作为参数的函数, 并返回一个新组件; 可复用的逻辑在函数中是实现.

pros:

- 模板可复用
- 不会出现命名冲突, 本质上是一个 HOC 套了一层父组件

cons: 组件复杂度高, 多层嵌套, 调试困难
